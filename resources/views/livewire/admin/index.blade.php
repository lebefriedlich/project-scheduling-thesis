                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr class="top">
                                            ...
                                            <th class="border-bottom-0 sorting fs-14 font-w500 text-center"
                                                tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" style="width: 150px;">Nama Mahasiswa</th>
                                            <th class="border-bottom-0 sorting fs-14 font-w500 text-center"
                                                tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" style="width: 250px;">Periode</th>
                                            <th class="border-bottom-0 sorting fs-14 font-w500 text-center"
                                                tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" style="width: 250px;">Pembimbing 1</th>
                                            <th class="border-bottom-0 sorting fs-14 font-w500 text-center"
                                                tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" style="width: 250px;">Pembimbing 2</th>
                                            <th class="border-bottom-0 sorting_disabled fs-14 font-w500 text-center"
                                                rowspan="1" colspan="1" style="width: 150px;">Lihat Dokumen
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center">{{ $data->semhas->sempro->secondMentor->name }}</td>
                                            <td class="text-center">
